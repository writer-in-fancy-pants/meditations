...
<article class="howto">
    ...
    <div class="howto-table-wrap">
      <table class="howto-table">
        ...
        <tbody>
          ...
          <tr><td>Hardware</td><td>Muse 2 + muselsl + bridge.py</td><td>Muse 2 PPG, or WHOOP via bridge.py</td></tr>
        </tbody>
      </table>
    </div>
  </section>
  ...
  <section class="howto-card howto-full">
    ...
    <div class="howto-checks">
      <label class="howto-check"><input type="checkbox" /> Muse 2 charged and paired via Bluetooth</label>
      <label class="howto-check"><input type="checkbox" /> muselsl installed: <code>pip install muselsl</code></label>
      <label class="howto-check"><input type="checkbox" /> Bridge running: <code>muselsl stream</code> + <code>python bridge.py</code></label>
