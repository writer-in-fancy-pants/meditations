  ...
  function initCharts({ hrId, rrId, rmssdId, maxPts = DEFAULT_MAX }) {
    ...
    if (rmssdId && document.getElementById(rmssdId)) {
      charts.rmssd = new Chart(document.getElementById(rmssdId), {
        ...
        options: _opts(cc, 'RMSSD (ms)', intCb),
      });
    }
